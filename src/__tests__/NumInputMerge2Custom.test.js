...
import NumInputMerge2 from "../components/QInput/";
...
describe("onClick Functionality", () => {
  describe("Tag as is", () => {
    it("", () => {
      const wrapper = shallow(<NumInputMerge2 />);
      const instance = wrapper.instance();
    });
  });
  describe("Tag with Memory Input", () => {
    ...
    it("", () => {
      const wrapper = shallow(<NumInputMerge2 unitConfig={Memory}/>);
      const instance = wrapper.instance();
    });
  });
  describe("tag with vCPU", () => {
    ...
    it("", () => {
      const wrapper = shallow(<NumInputMerge2 unitConfig={vCPU}/>);
      const instance = wrapper.instance();
    });
  });
  describe("tag with empty unit", () => {
    ...
    it("", () => {
      const wrapper = shallow(<NumInputMerge2 unitConfig={noUnit}/>);
      const instance = wrapper.instance();
    });
  });
});
