...
class BuildDetailTabStrategy extends React.Component<IProps, IState> {
  ...
  private readonly COMPONENT = 'BuildDetailTabStrategy';
...
// @ts-ignore
BuildDetailTabStrategy.propTypes = {
  handleChange: PropTypes.func.isRequired,
  inputValues: PropTypes.object.isRequired,
};

export default BuildDetailTabStrategy;
