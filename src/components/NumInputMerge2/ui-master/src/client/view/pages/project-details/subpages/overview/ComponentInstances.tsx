...
interface IProps {
  show: boolean;
  appName: string;
  runningInstances?: projModel.IUIProjectConsumptionInfo;
}
...
class ComponentInstances extends React.Component<IProps, IState> {
  private readonly COMPONENT = 'ComponentInstances';
